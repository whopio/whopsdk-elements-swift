...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Framework",
            url: "https://github.com/whopio/whopsdk-elements-swift/releases/download/0.1.11/WhopElements.xcframework.zip",
            checksum: "c5c0b154a270ab1f3d2e0a00d4e18da9962fce1eeebaeaabed7579ad6966014f"
        ),
    ],
