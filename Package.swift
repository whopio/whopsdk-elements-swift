...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Framework",
            url: "https://github.com/whopio/whopsdk-elements-swift/releases/download/0.1.7/WhopElements.xcframework.zip",
            checksum: "192be08e43929a1ff029ffea690f2633c276ab90e3b98e86a08b6508453aadfb"
        ),
    ],
