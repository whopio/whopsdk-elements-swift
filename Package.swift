...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Framework",
            url: "https://github.com/whopio/whopsdk-elements-swift/releases/download/0.1.10/WhopElements.xcframework.zip",
            checksum: "dd150890b7ba592954870bdf96de270abd7e6f7e8e8a65b48e94b1137781b75a"
        ),
    ],
