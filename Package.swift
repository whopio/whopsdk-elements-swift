...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Framework",
            url: "https://github.com/whopio/whopsdk-elements-swift/releases/download/0.1.8/WhopElements.xcframework.zip",
            checksum: "cec647a32bfeddca5e1b1faf51b39d8afbbe10304e9e4894dbf0c2d11165b600"
        ),
    ],
