...
### Fixed
- Send arrow contrast across custom chat themes
- DMs list rows jumping when the list first appears
...
_Release yanked due to duplicated xcframework_
...
### Added
- support for canadian eTransfers
...
### Changed
- removed conditional dependencies
